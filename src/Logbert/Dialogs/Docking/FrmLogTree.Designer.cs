namespace Com.Couchcoding.Logbert.Dialogs.Docking
{
  partial class FrmLogTree
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.tsLoggerTree = new Com.Couchcoding.GuiLibrary.Controls.ToolStripEx();
      ...
      this.tvLoggerTree = new Com.Couchcoding.GuiLibrary.Controls.TreeViewEx();
      ...
      this.tsbFilterRecursive.Image = global::Com.Couchcoding.Logbert.Properties.Resources.filter_16xLG;
    ...
    private Com.Couchcoding.GuiLibrary.Controls.ToolStripEx tsLoggerTree;
    ...
    private GuiLibrary.Controls.TreeViewEx tvLoggerTree;
  }
}

...
namespace WeifenLuo.WinFormsUI.Docking
{
    internal class VS2012LightDockPaneStrip : DockPaneStripBase
    {
      ...
      private static Pen _borderPen = new Pen(Color.FromArgb(204, 206, 219));
        ...
        private int MeasureHeight_Document()
        {
            return Math.Max(
              ...
              , ButtonClose.Height + DocumentButtonGapTop + DocumentButtonGapBottom) + DocumentStripGapBottom + DocumentStripGapTop;
        }
        ...
        private void DrawTabStrip_Document(Graphics g)
        {
            ...
            if (DockPane.DockPanel.DocumentTabStripLocation == DocumentTabStripLocation.Bottom)
                g.DrawLine(PenDocumentTabActiveBorder, rectTabStrip.Left, rectTabStrip.Top , rectTabStrip.Right, rectTabStrip.Top);
        ...
        private void DrawTab_Document(Graphics g, TabVS2012Light tab, Rectangle rect)
        {
            ...
            if (DockPane.ActiveContent == tab.Content)
            {
                if (DockPane.IsActiveDocumentPane)
                {
                    ...
                    if (DockPane.DockPanel.DocumentTabStripLocation == DocumentTabStripLocation.Bottom)
                        g.DrawLine(PenDocumentTabActiveBorder, rect.Left, rect.Top , rect.Right, rect.Top);
        ...
        {
            if (Appearance != Docking.DockPane.AppearanceStyle.Document || !m_closeButtonVisible)
            {
        ...
        private void WindowList_Click(object sender, EventArgs e)
        {
            ...
            foreach (TabVS2012Light tab in Tabs)
            {
                ...
                MenuItem item = SelectMenu.MenuItems.Add(content.DockHandler.TabText);
            ...
            SelectMenu.Show(
                ButtonWindowList
              , new Point(0, ButtonWindowList.Location.Y + ButtonWindowList.Height));
        }
